...
public class EmployeeController {
	...
	@GetMapping("employees/getLeaves")
	public List<LeaveDetails> getLeaveDetails() {
		return employeeService.getLeaveDetailsByEmployeeId();
	}

	@PostMapping("employees" +"/uploadDocuments"+ "/{empId}")
	public ResponseEntity<String> uploadPDFDocument(@RequestParam("file") MultipartFile file,
			@PathVariable(value = "empId") Integer empId) throws IOException {
		employeeService.uploadDocumentInDms(empId, file);
